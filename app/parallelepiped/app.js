...
async function refresh() {
    ...
    // Adjust editNumber. It's OK for it to be larger than the total number of edits in the template.
    const editNumber = document.getElementById("editNumber").value
    template = template.replace(`editNumber="0"`, `editNumber="${editNumber}"`)
